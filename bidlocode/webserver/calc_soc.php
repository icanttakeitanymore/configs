...
$date = date("Ymd");
$uploaddir = ("/var/www/webserver/uploads/soc$date/");
...
shell_exec("rm -rf /var/www/webserver/uploads/soc$date");
shell_exec("mkdir -m 777 /var/www/webserver/uploads/soc$date");
...
print_r($_FILES);
print "</pre>";
shell_exec("/var/www/webserver/cgi/conv_soc.sh $val1 $val2 $val3");
